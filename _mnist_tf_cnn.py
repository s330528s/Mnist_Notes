...
x   = tf.placeholder(tf.float32, [None, Num_Input]) # Input Data, 784 = 28*28 ( image size )
...
y_conv = tf.matmul(h_fc1_drop, W_fc2) + b_fc2 # Ouput Data from FC Layer 2.

cross_entropy = tf.reduce_mean(
    tf.nn.softmax_cross_entropy_with_logits(labels=y_, logits=y_conv)) # Loss Function.
